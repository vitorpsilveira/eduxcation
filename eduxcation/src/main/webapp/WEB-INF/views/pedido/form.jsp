...
<body>
	...
	<div class="container">
		<br>
		<f:form action="${s:mvcUrl('salvarPedidoCompraUrl').build()}"
			method="post" modelAttribute="pedidoCompraForm">
				...
				<div class="col s12">
					<div class="card">
						<div class="card-content">
							...
							<div class="row">
								...
								<div class="input-field col s9">
									<f:select path="pedidoCompra.condicaoPagamento"
										cssClass="validate">
										<f:option value="">Selecione</f:option>
										<f:options items="${listaDeCondicaoPagto}"
							...
							<div class="row">
								<div class="input-field col s12">
									<f:textarea path="pedidoCompra.observacao"
										cssClass="validate materialize-textarea" />
									<label for="pedidoCompra.observacao">Observações</label>
									<f:errors path="pedidoCompra.observacao" cssClass="helper-text" />
								</div>
							</div>

							<span class="card-title center-align"> Itens
													...
													<div class="row">
														<div class="input-field col s4">
															<f:select
																...
																cssClass="validate">
																<f:option value="">Selecione</f:option>
																<f:options items="${listaDeProdutos}" itemValue="id"
																	itemLabel="descricao" />
															</f:select>
															<label class="active"
														...
														<div class="input-field col s3">
															<f:input readonly="true" type="number"
																path="itensPedidoCompra[${status.index}].precoUnitario"
																cssClass="validate" />
															<label class="active"
																for="itensPedidoCompra[${status.index}].precoUnitario">Valor
																Unitário</label>
															<f:errors
																path="itensPedidoCompra[${status.index}].precoUnitario"
																cssClass="helper-text" />
						...
						<div class="card-action">
							<input class="btn-small s6 red lighten-2" type="submit"
								value="Salvar"> <a
								href="${s:mvcUrl('listarPedidoCompraUrl').build()}"
	...
	<script type="text/javascript">
		...
		$("body").on(
				...
				function(event) {
					...
					var elementoPrecoUnitario = $(this).closest(".row").find(
							"input[name$='precoUnitario']");
